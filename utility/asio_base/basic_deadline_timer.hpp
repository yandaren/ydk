...
#ifndef __ydk_utility_asiobase_basic_deadline_timer_hpp__
#define __ydk_utility_asiobase_basic_deadline_timer_hpp__
...
template <typename Time,
    typename TimeTraits = asio::detail::chrono_time_traits<Time, asio::wait_traits<Time>>,
    typename TimerService = utility::asio_base::deadline_timer_service<Time, TimeTraits> >
class basic_deadline_timer
  : public asio::basic_io_object<TimerService>
{
public:
  ...
  explicit basic_deadline_timer(asio::io_service& io_service)
    : asio::basic_io_object<TimerService>(io_service)
  {
  }
